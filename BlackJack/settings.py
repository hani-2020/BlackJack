...
SECRET_KEY = 'django-insecure-u9&v+is3fc(754fug!9k20p+_&#_#e=b8+3s6-obldxryqm@9@'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        'APP': {
            ...
            'secret': os.getenv("GOOGLE-SECRET-KEY"),
        },
        'SCOPE': [
            'profile',
            'email',
...
#for email sending shenanigans
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = os.getenv("EMAIL-NAME")
EMAIL_HOST_PASSWORD = os.getenv("EMAIL-PASSWORD")

#for allauth using email
